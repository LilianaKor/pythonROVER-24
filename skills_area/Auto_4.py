...
# print((a*a, a*4, round(a * (2 ** 0.skills_area))))
...
# 4.skills_area. Напишите декоратор, который высчитывает время работы функции, которую он принимает в качестве параметра
#import time
...
# print("Сложение:", add(skills_area, 3))
